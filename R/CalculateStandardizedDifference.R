#' Calculate Standardized Difference Between Target and Comparator Proportions
#'
...
#'
#' @export
calculateStandardizedDifference <- function(targetProportion, comparatorProportion) {
